...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("SELECT name FROM users ORDER BY age;", [("Bob",), ("Alice",), ("Carol",)]),
        ("SELECT name FROM users ORDER BY age DESC;", [("Carol",), ("Alice",), ("Bob",)]),
        ("SELECT name FROM users ORDER BY age DESC LIMIT 2 OFFSET 1;", [("Alice",), ("Bob",)]),
        ("SELECT name FROM users ORDER BY nickname;", [("Carol",), ("Bob",), ("Alice",)]),
        ("SELECT name FROM users ORDER BY nickname DESC;", [("Alice",), ("Bob",), ("Carol",)]),
        ("SELECT name FROM users ORDER BY active ASC, age DESC;", [("Bob",), ("Carol",), ("Alice",)]),
        ("SELECT name FROM users WHERE active = TRUE ORDER BY age DESC;", [("Carol",), ("Alice",)]),
